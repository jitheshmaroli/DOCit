...
router.get(
  '/subscription-plans',
  adminAuth,
  adminController.getAllPlans.bind(adminController)
);
router.delete(
...
router.get(
  '/subscriptions',
  adminAuth,
  adminController.getPatientSubscriptions.bind(adminController)
);
...
router.put(
  ...
  adminAuth,
  adminController.cancelAppointment.bind(adminController)
);
...
router.get(
  '/specialities',
  adminAuth,
  adminController.getSpecialities.bind(adminController)
);
router.post(
  '/specialities',
  adminAuth,
  adminController.addSpeciality.bind(adminController)
);
router.patch(
  '/specialities/:id',
  adminAuth,
  adminController.updateSpeciality.bind(adminController)
);
router.delete(
  '/specialities/:id',
  adminAuth,
  adminController.deleteSpeciality.bind(adminController)
);

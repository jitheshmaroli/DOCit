...
} from "./chunk-P5FELYMO.js";
import {
  PickersTextField,
  useFieldOwnerState
} from "./chunk-ZCGU2PZ2.js";
import {
...
} from "./chunk-PCIAOC5O.js";
import {
  refType_default,
  useEventCallback_default,
  useForkRef,
  useTimeout
} from "./chunk-OR7MY2XV.js";
import {
  alpha,
  composeClasses,
...
function useValidation(options) {
  ...
  const previousValidationErrorRef = React8.useRef(validator.valueManager.defaultErrorState);
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React9.useMemo(() => _extends({}, internalProps, validationProps, {
...
function useDatePickerDefaultizedProps(props, name) {
  ...
  const localeText = React10.useMemo(() => {
    var _a;
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React21.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React21.Fragment, {
  children: [(0, import_jsx_runtime9.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime9.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickerFieldUIContext = React22.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const translations = usePickerTranslations();
  const pickerContext = useNullablePickerContext();
  const pickerFieldUIContext = React22.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
...
var useFieldState = (parameters) => {
  ...
  const sectionsValueBoundaries = React24.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React24.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
    localeText: translations,
    localizedDigits,
    format,
  ...
  const parsedSelectedSections = React24.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  ...
  const areAllSectionsEmpty = React24.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React24.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React25.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React25.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React26.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React27.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React27.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React28.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React28.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React29.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React29.useMemo(() => ({
  ...
  React29.useImperativeHandle(unstableFieldRef, () => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel3(value);
  const sections = React30.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React30.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React30.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React30.useEffect(() => {
  ...
  const inputMode = React30.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React31.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
  return React31.useMemo(() => _extends({}, internalProps, validationProps, {
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React32.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React35.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
var _excluded14 = ["parentProps", "day", "focusedDay", "selectedDays", "isDateDisabled", "currentMonthNumber", "isViewFocused"];
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React38.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
...
var MonthCalendarButton = React39.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime16.jsx)(MonthButton, _extends({}, monthButtonProps));
});
if (true) MonthCalendarButton.displayName = "MonthCalendarButton";

// node_modules/@mui/x-date-pickers/esm/MonthCalendar/MonthCalendar.js
var import_jsx_runtime17 = __toESM(require_jsx_runtime(), 1);
var _excluded16 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React40.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(utils, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime17.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
var _excluded17 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var YearCalendarButton = React41.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime18.jsx)(YearButton, _extends({}, yearButtonProps));
});
if (true) YearCalendarButton.displayName = "YearCalendarButton";

// node_modules/@mui/x-date-pickers/esm/YearCalendar/YearCalendar.js
var import_jsx_runtime19 = __toESM(require_jsx_runtime(), 1);
var _excluded18 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsOrder", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var YearCalendar = React42.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime19.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime19.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
var _excluded19 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId", "classes"];
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const utils = useUtils();
  const cleanDate = React44.useMemo(() => !utils.isValid(date) ? null : date, [utils, date]);
...
var _excluded20 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "classes", "timezone", "format"];
...
var useMobilePicker = (_ref) => {
  ...
  const _useSlotProps = useSlotProps_default({
    ...
    ownerState
  }), fieldProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded29);
  const Layout = slots.layout ?? PickersLayout;
  let labelledById = labelId;
  if (isToolbarHidden) {
    if (label) {
  ...
  const renderPicker = () => (0, import_jsx_runtime25.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime25.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime25.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime25.jsx)(PickersModalDialog, {
        slots,
        slotProps,
        children: (0, import_jsx_runtime25.jsx)(Layout, _extends({}, slotProps == null ? void 0 : slotProps.layout, {
          slots,
          slotProps,
          children: renderCurrentView()
        }))
...
//# sourceMappingURL=chunk-2DWY2UUL.js.map
